...
import { EnsayoList } from '../components/ensayos/EnsayoList';
import { EnsayoForm } from '../components/ensayos/EnsayoForm';
...
export default function Ensayos() {
  ...
  const handleSaveEnsayo = (updatedMuestra: Muestra) => {
    updateMuestra(updatedMuestra.id, updatedMuestra);
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Ejecución de Ensayos</h1>

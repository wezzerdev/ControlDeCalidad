...
export function CertificateTemplate({ muestra, proyecto, norma, companyInfo, template }: CertificateTemplateProps) {
  ...
  return (
    <div className={cn(
      ...
      // Carta size: 216mm x 279mm
      // We set specific max-width to match Letter size in screen
      "max-w-[216mm] min-h-[279mm] w-full print:w-full print:max-w-none print:min-h-0 print:h-auto",
